...
def parse_execution(data, file_names):
    ...
    coleta.chave_coleta = IDColeta("mpto", month, year)
    coleta.orgao = "mpto"
    coleta.mes = int(month)
    coleta.ano = int(year)
    coleta.repositorio_coletor = "https://github.com/dadosjusbr/coletor-mpto"
...
def main():
    ...
    # file_names = ["./output/membros-ativos-contracheque-06-2019.ods", "./output/membros-verbas-indenizatorias-06-2019.ods"]
