...
def links_remuneration(month, year):
    ...
    cod_2021 = {
        ...
        "5": "18ada5789d83347f771b2d75bc4002df",
        "6": "87db03d097cadf4cc489043f215830fa",
        "7": "ddd5182eb2cab16e77a89c9374402335",
...
def links_other_funds(month, year):
    ...
    cod_2021 = {
        ...
        "5": "ee33f26cef033847bb05713a23b6a43a",
        "6": "5d5300e8e45129a3f0ee4149d1ce287b",
        "7": "f6b0d1046706cc02318483849dc84fd3",
...
def crawl(year, month, output_path):
    ...
    for element in urls_remuneration:
        ...
        file_name = f"membros-ativos-contracheque-{month}-{year}.ods"
    ...
    for element in urls_other_funds:
        pathlib.Path(output_path).mkdir(exist_ok=True)
        file_name_indemnity = f"membros-verbas-indenizatorias-{month}-{year}.ods"
